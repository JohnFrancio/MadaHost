...
// GET /api/github/repos - Récupérer tous les repositories de l'utilisateur
...
// GET /api/github/repos/:owner/:repo/branches - Obtenir les branches d'un repository
router.get(
...
// POST /api/github/repos/:owner/:repo/detect-framework - Détecter automatiquement le framework
router.post(
...
// GET /api/github/user - Obtenir les informations de l'utilisateur GitHub connecté
...
// GET /api/github/test - Route de test pour debug
