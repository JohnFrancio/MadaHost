  ...
  <div class="max-w-md mx-auto animate-fade-in-scale">
    <div class="card text-center hover-lift">
      ...
      <div class="grid grid-cols-1 gap-3 mb-8 text-left">
        <div
          class="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl"
        >
          <div class="w-2 h-2 bg-green-500 rounded-full"></div>
          <span class="text-sm text-gray-700 dark:text-gray-300"
            >Déploiement automatique</span
          >
        </div>
        <div
          class="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl"
      ...
      >
        ...
        <span class="text-lg">{{
          authStore.loading ? "Connexion..." : "Continuer avec GitHub"
        }}</span>
      </button>
      ...
      <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800">
        ...
        <div
          class="mt-4 flex items-center justify-center space-x-4 text-xs text-gray-400 dark:text-gray-500"
        >
